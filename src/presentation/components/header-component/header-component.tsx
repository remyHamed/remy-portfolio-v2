...
export const HeaderComponent: React.FC = () => {
    ...
    const handleShowLinks = () => {
        ...
        console.log("setShowlinks = "  + showlinks);

        if (showlinks && divRef.current && showlinks) {
        ...
        return (
            <header ref={divRef} data-testid="header">
                    <div id="logo-header-div">
                        <img id="logo-header" src={logo} alt="Logo"></img>
                        <h3>Remy Hamed</h3>
                    </div>
                    <nav className={`${showlinks ? "show-header" : "hide-header" }`}>
                        <ul>
                            ...
                            <li>
                                <a href="pages\education_and_training\education_and_training.html">Diplôme et Formation</a>
                                <span className="dot"></span>
                            </li>
                            <li>
